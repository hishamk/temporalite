...
[![Go Reference](https://pkg.go.dev/badge/github.com/hishamk/temporalite.svg)](https://pkg.go.dev/github.com/hishamk/temporalite)
[![ci](https://github.com/hishamk/temporalite/actions/workflows/ci.yml/badge.svg)](https://github.com/hishamk/temporalite/actions/workflows/ci.yml)
...
Download and extract the [latest release](https://github.com/hishamk/temporalite/releases/latest) from [GitHub releases](https://github.com/hishamk/temporalite/releases).
...
- When consuming Temporalite as a library in go mod, you may want to replace grpc-gateway with a fork to address URL escaping issue in UI. See <https://github.com/hishamk/temporalite/pull/118>
